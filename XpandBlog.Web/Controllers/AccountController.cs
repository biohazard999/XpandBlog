...
namespace XpandBlog.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Disassociate(string loginProvider, string providerKey)
        {
            ...
            IdentityResult result = await UserManager.RemoveLoginAsync(Convert.ToInt32(User.Identity.GetUserId()), new UserLoginInfo(loginProvider, providerKey));
            if (result.Succeeded)
            {
        ...
        {
            var linkedAccounts = UserManager.GetLogins(Convert.ToInt32(User.Identity.GetUserId()));
